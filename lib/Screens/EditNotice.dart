...
class _EditNoticeState extends State<EditNotice> {
  ...
  setData() {
    setState(() {
      txtTitle.text = widget.noticeData["Title"];
      txtDescription.text = widget.noticeData["Description"];
      _dateTime = DateTime.parse(widget.noticeData["Date"]);
    });
  }
